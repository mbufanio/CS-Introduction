...
- [ ] Test-run `step3_class_demo.m` once — Section 4 opens a figure window (if it hides
...
### 0:07–0:24 · Demo: `step3_class_demo.m` (two acts)
...
Open `step7_class_challenge.m`: the **Monty Hall problem** — tell the game-show story from the
