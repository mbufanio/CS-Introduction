...
- [ ] Test-run `step3_class_demo.m` once — Section 7 asks you to type five names live
...
### 0:07–0:23 · Demo: `step3_class_demo.m`
...
### 0:23–0:31 · Class writes code: `step4_class_fill_in_the_blank.m`
...
extra valuable — see the file. Completed code is in `step2_teacher_answer_key.md`.
...
Open `step7_class_challenge.m`: temperature converters that round-trip through each other
