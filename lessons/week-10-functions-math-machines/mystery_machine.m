...
%
%   (The rule: out = n × n. Squaring. A kid who says 'times itself' is
%    right; a kid who says 'n squared' gets the vocabulary high-five.)
% ==============================================================================

function out = mystery_machine(n)
    out = n * n;            % ← the secret. Do not read aloud. Act natural.
end
