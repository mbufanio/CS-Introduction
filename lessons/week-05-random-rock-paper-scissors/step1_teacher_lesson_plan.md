...
- [ ] Test-run `step3_class_demo.m` once — Section 8's match needs you to type 5 throws
- [ ] Hook prop: one coin to flip
- [ ] Swap real student names into the line-leader mapping in `step3_class_demo.m`,
...
### 0:07–0:20 · Demo: `step3_class_demo.m` (Sections 1–7)
...
### 0:20–0:27 · Class writes code: `step4_class_fill_in_the_blank.m`
...
type the if/else live. Completed code in `step2_teacher_answer_key.md`.

### 0:27–0:33 · Voting game: `step5_class_predict_the_output.m`
...
### 0:33–0:40 · 🎉 THE MATCH: `step3_class_demo.m` Section 8
...
Open `step7_class_challenge.m`: a Magic 8-Ball (an 8-way mapping you can re-run for every question
