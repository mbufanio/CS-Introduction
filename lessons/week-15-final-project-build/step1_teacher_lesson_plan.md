...
- [ ] Print `step6_class_handout.md` — the **design sheet** — one per pair/group, plus spares
...
- [ ] Test-run `step3_class_demo.m` once so you can play it smoothly (any path — it's short)
- [ ] Board markers ready: you'll draw the map live
- [ ] Read `step2_teacher_answer_key.md`'s sample story so you know what a finished skeleton looks like
...
### 0:02–0:07 · Hook: play `step3_class_demo.m` live
...
fastest is numbering off). Using `step6_class_handout.md` they write: the room's name, what the
...
Open `step4_class_fill_in_the_blank.m` — the class game skeleton. The engine is fully wired the
...
sheets go missing, `step2_teacher_answer_key.md` contains a complete sample story you can pour into
...
Open `step7_class_challenge.m`: four upgrade modules ready to bolt onto the class game — a
