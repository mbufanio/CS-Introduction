...
30–45 seconds, then run the first section of `lesson_demo.m`: the computer answers
...
`mod` to the right jobs. Completed code is in `answer-key.md`.
...
Open `challenge.m`: a your-age-in-seconds calculator to personalize with real ages,
