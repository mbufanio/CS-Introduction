...
- [ ] Test-run `step3_class_demo.m` once — and rehearse the Ctrl+C move in Section 2 so
...
### 0:07–0:22 · Demo: `step3_class_demo.m` (Sections 1–4)
...
### 0:22–0:29 · Class writes code: `step4_class_fill_in_the_blank.m`
...
the `>`. Completed code in `step2_teacher_answer_key.md`.

### 0:29–0:35 · Voting game: `step5_class_predict_the_output.m`
...
### 0:35–0:41 · 🎉 THE FLIP: `step3_class_demo.m` Sections 5–6
...
Open `step7_class_challenge.m`: the guessing game with 7 lives (is 7 enough? — they can now
