...
- [ ] Test-run `lesson_demo.m` once (no typing needed — it runs straight through)
...
Task 7 is typed live: the class dictates the `*`. Completed code in `answer-key.md`.

### 0:30–0:38 · Voting game: `predict_the_output.m`
...
Open `challenge.m`: all 99 verses of "99 Bottles of Pop" in a blink (with if/elseif
